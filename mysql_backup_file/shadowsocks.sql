...
CREATE TABLE `free_user` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_port` (`port`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='免费用户';
...
CREATE TABLE `node_free` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='免费节点';
